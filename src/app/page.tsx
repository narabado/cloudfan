...
function calcDaysLeft(deadline: string): number {
  if (!deadline || deadline.trim() === '') return 0;
...
export default function TopPage() {
  ...
  const ProjectCard = ({ project }: { project: Project }) => {
    ...
    const mainImage = (project.images ?? []).find((u) => typeof u === 'string' && u.startsWith('http')) ?? null;
      ...
      >
        ...
        <div style={{ position: 'relative', aspectRatio: '16/9', overflow: 'hidden', background: '#e2e8f0' }}>
          ...
          <div style={{ position: 'absolute', bottom: 12, left: 16, right: 16 }}>
            <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: 12, margin: '0 0 4px' }}>
              {project.school} {project.club && `・${project.club}`}
            </p>
        ...
        <div style={{ padding: '18px 20px 20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            ...
            <button
              onClick={() => router.push(`/support/${project.id}`)}
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ color: '#6b7280', fontSize: 14 }}>
            北海道のバドミントン部・クラブチームが抱える課題をみんなで解決
          </p>
        </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid',
          ...
          {[
            ...
            { step: '02', icon: '💰', title: '支援プランを選ぶ',   desc: '¥1,000〜好きな金額・プランを選択' },
            ...
            <div key={s.step} style={{ background: '#fff', borderRadius: 14,
              ...
              <div style={{ width: 48, height: 48,
                ...
                fontSize: 12, fontWeight: 800, color: '#fff', letterSpacing: 0 }}>
                {s.step}
              </div>
