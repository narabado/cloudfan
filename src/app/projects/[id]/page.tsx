                    ...
                    <div key={i} style={{ marginBottom: 48, paddingBottom: 40, borderBottom: i < storyBlocks.length - 1 ? '2px dashed #e2e8f0' : 'none' }}>
                      ...
                      {block.image_url && (
                        <img src={block.image_url} alt={`story-${i}`}
                          style={{ width: '100%', objectFit: 'contain', width: '100%', maxHeight: '400px', background: '#f8fafc', borderRadius: 12, boxShadow: '0 4px 16px rgba(0,0,0,0.12)', display: 'block', marginBottom: 20 }} />
                      )}
